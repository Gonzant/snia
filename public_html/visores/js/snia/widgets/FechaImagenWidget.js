/*
 * js/snia/widgets/FechaImagenWidget
 * 
 */
...
define([
    ...
    "dojo/text!./templates/FechaImagenWidget.html",
    ...
    var widget = declare([_WidgetBase, _TemplatedMixin, _WidgetsInTemplateMixin, Evented], {
        ...
        startup: function () {
            ...
            if (!this.mapa) {
                this.destroy();
                console.log('FechaImagenWidget::requiere un mapa');
            }
            //  mapa cargado
            if (this.mapa.loaded) {
                this._init();
        ...
        _mapaReload : function () {
            this._mapMouseMoveListener.remove();
            this._mapMouseMoveListener = on(this.mapa.map, "extent-change", lang.hitch(this, this._mapMouseMove));
        },
        _mapMouseMove : function (evt) {
            var g3sr, g;
            var server = "http://services.arcgisonline.com/arcgis/rest/services/World_Imagery/MapServer/0";
