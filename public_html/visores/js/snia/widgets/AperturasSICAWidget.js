...
//            this._cpDerq.domNode.innerText = " ";
...
//                        //estoy en la apertura a recorrer
				...
				{  noscroll: true,   cells: [ ]},
                        ...
                        for (a = 1; a < this.config.data[i].columnas.length; a = a + 1) {
                             layout[1].cells[0].push({name: this.config.data[i].columnas[a], field :this.config.data[i].columnasField[a],  width: "70px" });
                        }
                        
                        for (a = 0; a < this.config.data[i].divisiones.length; a = a + 1) {
                              layout[1].cells[1].push({name: this.config.data[i].divisiones[a], field: "", colSpan: "2"});
...
//                                
////                                {noscroll: true, cells: [
////				{ name: this.config.data[i].columnas[0], field: this.config.data[i].filas[a], width: "84px" }
////			]}
//                                
//                                
//                            break;
